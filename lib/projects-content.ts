...
export type Project = {id:string;name:string;detail:string;status:string;image:string;imageAlt:string;location?:string;totalFlats?:number;area?:string;completedOn?:string};
